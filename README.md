...
This Repo is for object classification coding practice. A simple dataset having 2 classes (10,000 pictures in total) is used to build different CNN architectures such as:
